        ...
        <div className="container mx-auto px-6 py-3">
            <div className="flex items-center justify-between">
                <div className="hidden w-full text-gray-600 md:flex md:items-center">
                    ...
                    <span className="mx-1 text-sm">MW</span>
                </div>
                ...
                <div className="flex items-center justify-end w-full">
                  {/* toggle open */}
                    ...
                    <div className="flex sm:hidden">
                        <button onClick={ToggleNav}  type="button" className="text-gray-600 hover:text-gray-500 focus:outline-none focus:text-gray-500" aria-label="toggle menu">
            ...
            <nav className={ isOpen ? 'sm:flex sm:justify-center sm:items-center mt-4 ' : 'sm:flex sm:justify-center sm:items-center mt-4 hidden'}>
